...
| 36 | Bluetooth Transport | PASS_SOFTWARE_SUBSTITUTE | mock_ble TCP framing only; iOS GATT **absent on main** (SoT `feature/raven-serverless-v1` until B8); RBF1 held; physical GATT **BLOCKED_HARDWARE** |
