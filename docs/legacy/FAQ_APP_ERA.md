> **Historical — application era.** This FAQ was written for the 2026 iOS app
> with a FastAPI backend (accounts, Sign in with Apple/Google, server-stored
> media, news interests, BLE mesh chat rooms). It does not describe the current
> serverless terminal product; see the root [`README.md`](../../README.md) and
> [`FAQ.md`](../../FAQ.md). Kept for history only.
