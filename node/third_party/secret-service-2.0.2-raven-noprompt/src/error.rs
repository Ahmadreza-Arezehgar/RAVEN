...
pub enum Error {
    ...
    Parse,
    Prompt,
    /// Create/Delete returned a prompt path; Raven refused to execute Prompt.Prompt.
    PromptRequired,
}
...
impl fmt::Display for Error {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        match *self {
            ...
            Error::PromptRequired => write!(f, "SS error: prompt required but execution refused"),
        }
    }
}
