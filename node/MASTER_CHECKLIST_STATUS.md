...
| 36 | Bluetooth Transport | PASS_SOFTWARE_SUBSTITUTE | mock_ble TCP framing only; iOS GATT **unverified** (0 `.swift` / `ios-native` absent); RBF1 held; physical GATT **BLOCKED_HARDWARE** |
